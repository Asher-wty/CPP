...
class Fan :public IElectricalEquipment{
    public:
        virtual void PowerOn(){cout<<"风扇打开"<<endl;}
        virtual void PowerOff(){cout<<"风扇关闭"<<endl;}
};
class Light:public IElectricalEquipment{
    public:
        virtual void PowerOn(){cout<<"电灯打开"<<endl;}
        virtual void PowerOff(){cout<<"电灯关闭"<<endl;}
};
class FancySwitch:public Switch{
    virtual void On(){cout<<"Fancy Switch On"<<endl; Elec->PowerOn();}
    virtual void Off(){cout<<"Fancy Switch Off"<<endl; Elec->PowerOff();}
};
class NormalSwitch:public Switch{
    virtual void On(){cout<<"Normal Switch On"<<endl; Elec->PowerOn();}
    virtual void Off(){cout<<"Normal Switch Off"<<endl; Elec->PowerOff();}
};
